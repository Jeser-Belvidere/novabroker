...
import { _ as _export_sfc, d as useSeoMeta, C as useToast, e as useAppConfig, t as tv, g as get, f as _sfc_main$d, B as _sfc_main$8$1, h as formBusInjectionKey, i as formStateInjectionKey, j as formErrorsInjectionKey, k as formInputsInjectionKey, l as formLoadingInjectionKey, m as formOptionsInjectionKey, o as inputIdInjectionKey, p as formFieldInjectionKey, q as useFormField, r as usePortal, s as useFieldGroup, v as useComponentIcons, w as isArrayOfArray, x as _sfc_main$b, y as _sfc_main$c, z as looseToNumber, A as getDisplayValue } from './server.mjs';
  ...
  setup(__props, { emit: __emit }) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(ssrRenderComponent(_component_UForm, mergeProps({
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<div class="calculator-container" data-v-fbe86d20${_scopeId}><div class="calculator-row" data-v-fbe86d20${_scopeId}>`);
            ...
            _push2(`</div><div class="calculator-row" data-v-fbe86d20${_scopeId}><div class="cost-input" data-v-fbe86d20${_scopeId}>`);
            _push2(ssrRenderComponent(_component_UFormField, {
              class: "text-md",
              required: "",
              label: "Стоймость",
            ...
            _push2(`</div><div class="calculator-row" data-v-fbe86d20${_scopeId}>`);
            _push2(ssrRenderComponent(_component_UFormField, {
              class: "text-md",
              label: "Масса, тонн",
              size: "xl",
              ...
              required: unref(isMassInputRequired)
            }, {
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
            ...
            if (!unref(isHybridEngine)) {
              _push2(`<div class="power-input" data-v-fbe86d20${_scopeId}>`);
              _push2(ssrRenderComponent(_component_UFormField, {
                class: "text-md",
                required: "",
                label: "Мощность",
              ...
              _push2(`<div class="power-type" data-v-fbe86d20${_scopeId}>`);
              _push2(ssrRenderComponent(_component_UFormField, {
                class: "text-md",
                name: "powerType",
                disabled: unref(isPowerDisabled)
            ...
            if (unref(isHybridEngine)) {
              ...
              _push2(ssrRenderComponent(_component_UFormField, {
                ...
                default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                  if (_push3) {
                    _push3(ssrRenderComponent(_component_UInput, mergeProps({
                      modelValue: unref(formState).power_hybrid_dvs,
            ...
            if (unref(isHybridEngine)) {
              ...
              _push2(ssrRenderComponent(_component_UFormField, {
                ...
                default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                  if (_push3) {
                    _push3(ssrRenderComponent(_component_UInput, mergeProps({
                      modelValue: unref(formState).power_hybrid_electro,
            ...
            _push2(`</div><div class="bus-eco-class" data-v-fbe86d20${_scopeId}>`);
            if (unref(formState).ts_type === "13_8702") {
              _push2(ssrRenderComponent(_component_UFormField, {
                class: "text-md mx-4",
                size: "xl",
            ...
            _push2(`</div><div class="actions" data-v-fbe86d20${_scopeId}>`);
...
const __nuxt_component_1 = /* @__PURE__ */ Object.assign(_export_sfc(_sfc_main$2, [["__scopeId", "data-v-fbe86d20"]]), { __name: "CalculatorForm" });
...
//# sourceMappingURL=tamozhennyy_kalkulyator-xukyxKuB.mjs.map
