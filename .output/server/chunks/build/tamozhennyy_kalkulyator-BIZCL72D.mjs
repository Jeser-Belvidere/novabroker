...
const _sfc_main$1 = /* @__PURE__ */ defineComponent({
  ...
  setup(__props, { emit: __emit }) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      const _component_UButton = _sfc_main$8$1;
      _push(`<div${ssrRenderAttrs(mergeProps({ class: "result-container" }, _attrs))} data-v-bb61e8f3><div class="result-content" data-v-bb61e8f3><div class="result-input" data-v-bb61e8f3><h3 data-v-bb61e8f3>Введенные данные</h3><table class="input-table" data-v-bb61e8f3><tbody data-v-bb61e8f3><tr data-v-bb61e8f3><th scope="col" data-v-bb61e8f3>Возраст:</th><td data-v-bb61e8f3>${ssrInterpolate(props.input?.age ? unref(AGE_OPTIONS_MAP)[props.input.age] : "Не указано")}</td></tr><tr data-v-bb61e8f3><th scope="col" data-v-bb61e8f3>Стоймость автомобиля:</th><td data-v-bb61e8f3>${ssrInterpolate(props.input?.cost ? props.input.cost + " " + unref(CURRENCY_OPTIONS_MAP)[props.input.currency] : "Не указано")}</td></tr><tr data-v-bb61e8f3><th scope="col" data-v-bb61e8f3>Тип двигателя:</th><td data-v-bb61e8f3>${ssrInterpolate(props.input?.engine_type ? unref(ENGINE_TYPES_MAP)[props.input.engine_type] : "Не указано")}</td></tr><tr data-v-bb61e8f3><th scope="col" data-v-bb61e8f3>Мощность:</th><td data-v-bb61e8f3>${ssrInterpolate(props.input?.power ? props.input?.power + " " + unref(POWER_TYPES_MAP)[props.input?.power_edizm] : "Не указано")}</td></tr>`);
      if (props.input?.volume) {
        _push(`<tr data-v-bb61e8f3><th scope="col" data-v-bb61e8f3>Объем двигателя:</th><td data-v-bb61e8f3>${ssrInterpolate(props.input?.volume + " см3")}</td></tr>`);
      } else {
        _push(`<!---->`);
      }
      _push(`</tbody></table></div><div class="result-output" data-v-bb61e8f3><h3 data-v-bb61e8f3>Расчет таможенных сборов при ввозе тс на ${ssrInterpolate(new Date(Date.now()).toLocaleDateString("ru-RU"))}</h3><table data-v-bb61e8f3><caption data-v-bb61e8f3> Примерные результаты расчета. Для точного расчета обратитесь к нашим специалистам * </caption><thead data-v-bb61e8f3><tr data-v-bb61e8f3><th scope="col" data-v-bb61e8f3>Платеж</th><th scope="col" data-v-bb61e8f3>Ставка</th><th scope="col" data-v-bb61e8f3>Сумма (руб)</th></tr></thead><tbody data-v-bb61e8f3><tr data-v-bb61e8f3><th scope="row" data-v-bb61e8f3>Таможенное оформление</th><td data-v-bb61e8f3>${ssrInterpolate(prepareNumberInString(props.result?.tam_oform?.name))}</td><td data-v-bb61e8f3>${ssrInterpolate(prepareNumberInString(props.result?.tam_oform?.name))}</td></tr>`);
      if (props.input?.face === "nat") {
        _push(`<tr data-v-bb61e8f3><th scope="row" data-v-bb61e8f3>Единая ставка</th><td data-v-bb61e8f3>${ssrInterpolate(props.result?.poshl?.name)}</td><td data-v-bb61e8f3>${ssrInterpolate(prepareNumber(props.result?.poshl?.value_rub))} руб.</td></tr>`);
      } else {
        _push(`<!---->`);
      }
      if (props.input?.face === "jur" || props.input?.sequential === true || props.input?.engine_type === "electric") {
        _push(`<tr data-v-bb61e8f3><th scope="row" data-v-bb61e8f3>Пошлина</th><td data-v-bb61e8f3>${ssrInterpolate(props.result?.poshl?.name)}</td><td data-v-bb61e8f3>${ssrInterpolate(prepareNumber(props.result?.poshl?.value_rub))} руб.</td></tr>`);
      } else {
        _push(`<!---->`);
      }
      if (props.input?.face === "jur" || props.input?.sequential === true || props.input?.engine_type === "electric") {
        _push(`<tr data-v-bb61e8f3><th scope="row" data-v-bb61e8f3>Акциз</th><td data-v-bb61e8f3>${ssrInterpolate(props.result?.akciz?.name)}</td><td data-v-bb61e8f3>${ssrInterpolate(prepareNumber(props.result?.akciz?.value_rub))} руб.</td></tr>`);
      } else {
        _push(`<!---->`);
      }
      if (props.input?.face === "jur" || props.input?.sequential === true || props.input?.engine_type === "electric") {
        _push(`<tr data-v-bb61e8f3><th scope="row" data-v-bb61e8f3>НДС</th><td data-v-bb61e8f3>${ssrInterpolate(props.result?.nds?.name)}</td><td data-v-bb61e8f3>${ssrInterpolate(prepareNumber(props.result?.nds?.value_rub))} руб.</td></tr>`);
      } else {
        _push(`<!---->`);
      }
      _push(`<tr data-v-bb61e8f3><th scope="row" data-v-bb61e8f3>Утиль сбор</th><td data-v-bb61e8f3>${ssrInterpolate(prepareNumber(props.result?.util_sbor.value_base))} руб. x ${ssrInterpolate(props.result?.util_sbor.value_coef)}</td><td data-v-bb61e8f3>${ssrInterpolate(prepareNumber(props.result?.util_sbor.value_rub))} руб.</td></tr></tbody><tfoot data-v-bb61e8f3><tr data-v-bb61e8f3><th colspan="2" scope="row" data-v-bb61e8f3>Итого c утилизационным сбором</th><td class="result-sum" data-v-bb61e8f3>${ssrInterpolate(prepareNumber(props.result?.sum_util.value_rub))} руб.</td></tr></tfoot></table></div></div><div class="result-actions" data-v-bb61e8f3>`);
...
const __nuxt_component_2 = /* @__PURE__ */ Object.assign(_export_sfc(_sfc_main$1, [["__scopeId", "data-v-bb61e8f3"]]), { __name: "CalculatorResult" });
...
//# sourceMappingURL=tamozhennyy_kalkulyator-BIZCL72D.mjs.map
