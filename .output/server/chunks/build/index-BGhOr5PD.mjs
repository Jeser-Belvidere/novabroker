import { _ as _export_sfc, c as useHead, d as useSeoMeta, b as __nuxt_component_0$2 } from './server.mjs';
...
import { g as getNewsFeed } from './newsFeed-CjxfiUz8.mjs';
...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<main${ssrRenderAttrs(_attrs)} data-v-e7de1b4a><div class="breadcrumbs margin-bottom" data-v-e7de1b4a>`);
      ...
      _push(`</div><div class="title margin-bottom" data-v-e7de1b4a><div class="title-head" data-v-e7de1b4a>Новости и обновления</div><div class="title-description" data-v-e7de1b4a> Оформление, сертификация, законодательство - все по делу </div></div><div class="first-card margin-bottom" data-v-e7de1b4a>`);
      _push(ssrRenderComponent(_component_nuxt_link, {
        class: "first-card",
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<div class="card-image" style="${ssrRenderStyle(`background-image: url(${unref(lastNews)?.imgSrc})`)}" data-v-e7de1b4a${_scopeId}></div><div class="card-info" data-v-e7de1b4a${_scopeId}><div class="card-title" data-v-e7de1b4a${_scopeId}>${ssrInterpolate(unref(lastNews)?.title)}</div><div class="card-date" data-v-e7de1b4a${_scopeId}>${ssrInterpolate(unref(lastNews)?.date)}</div></div>`);
          } else {
            return [
              createVNode("div", {
                class: "card-image",
      ...
      _push(`</div><div class="grid" data-v-e7de1b4a><!--[-->`);
      ssrRenderList(unref(restNews), (news, index2) => {
        _push(`<div class="${ssrRenderClass(`card card-${index2 + 1}`)}"${ssrRenderAttr("title", news.title)} data-v-e7de1b4a>`);
        _push(ssrRenderComponent(_component_nuxt_link, {
          class: "card",
          ...
          default: withCtx((_, _push2, _parent2, _scopeId) => {
            if (_push2) {
              _push2(`<div class="card-image" style="${ssrRenderStyle(`background-image: url(${news.imgSrc})`)}" data-v-e7de1b4a${_scopeId}></div><div class="card-info" data-v-e7de1b4a${_scopeId}><div class="card-title" data-v-e7de1b4a${_scopeId}>${ssrInterpolate(news.title)}</div><div class="card-date" data-v-e7de1b4a${_scopeId}>${ssrInterpolate(news.date)}</div></div>`);
            } else {
              return [
                createVNode("div", {
                  class: "card-image",
...
const index = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-e7de1b4a"]]);

export { index as default };
//# sourceMappingURL=index-BGhOr5PD.mjs.map
