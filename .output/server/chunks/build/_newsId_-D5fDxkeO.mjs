...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<main${ssrRenderAttrs(_attrs)} data-v-5c978720><section data-v-5c978720><div class="breadcrumbs margin-bottom" data-v-5c978720>`);
      ...
      _push(`</div><h1 class="margin-bottom" data-v-5c978720>${ssrInterpolate(unref(currentNews)?.title)}</h1><div class="image margin-bottom" style="${ssrRenderStyle(`background-image: url(${unref(currentNews)?.imgSrc})`)}" data-v-5c978720></div><div class="image-subtitle margin-bottom" data-v-5c978720>${ssrInterpolate(unref(currentNews)?.date)}</div><div class="content" data-v-5c978720><!--[-->`);
      ssrRenderList(unref(currentNews)?.newsBlocks, (newsBlock, index) => {
        _push(`<div class="margin-bottom" data-v-5c978720>`);
...
const _newsId_ = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-5c978720"]]);

export { _newsId_ as default };
//# sourceMappingURL=_newsId_-D5fDxkeO.mjs.map
