import { _ as _export_sfc, b as __nuxt_component_0$2, D as fetchDefaults, E as useAsyncData, F as useRequestFetch } from './server.mjs';
import { _ as __nuxt_component_0$1 } from './Link-3yjuZr9i.mjs';
...
const _sfc_main$3 = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<div${ssrRenderAttrs(mergeProps({ ref: "menu" }, _attrs))} data-v-dc69d125><svg class="${ssrRenderClass([unref(isActive) ? "active" : "", "ham hamRotate ham"])}" viewBox="0 0 100 100" width="60" data-v-dc69d125><path class="line top" d="m 30,33 h 40 c 3.722839,0 7.5,3.126468 7.5,8.578427 0,5.451959 -2.727029,8.421573 -7.5,8.421573 h -20" data-v-dc69d125></path><path class="line middle" d="m 30,50 h 40" data-v-dc69d125></path><path class="line bottom" d="m 70,67 h -40 c 0,0 -7.5,-0.802118 -7.5,-8.365747 0,-7.563629 7.5,-8.634253 7.5,-8.634253 h 20" data-v-dc69d125></path></svg>`);
      if (unref(isActive)) {
        _push(`<div class="dropdown" data-v-dc69d125><div class="dropdown__content" data-v-dc69d125>`);
...
const __nuxt_component_2 = /* @__PURE__ */ Object.assign(_export_sfc(_sfc_main$3, [["__scopeId", "data-v-dc69d125"]]), { __name: "UIMenu" });
const _sfc_main$2 = /* @__PURE__ */ defineComponent({
  ...
  async setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<header${ssrRenderAttrs(mergeProps({ class: "header" }, _attrs))} data-v-578efbe6><div class="header-content" data-v-578efbe6>`);
      ...
      _push(`<div class="header-content__links" data-v-578efbe6>`);
      ...
      _push(`</div><div class="header-content__contacts" data-v-578efbe6>`);
      ...
      _push(`</div><div class="mobile-menu" data-v-578efbe6>`);
      _push(ssrRenderComponent(_component_UIMenu, null, null, _parent));
      _push(`</div></div>`);
      if (!unref(error)) {
        _push(`<div class="header-currency" data-v-578efbe6><div class="header-currency__content" data-v-578efbe6> $: <span data-v-578efbe6>${ssrInterpolate(unref(currencies)?.USD?.value)} <span class="${ssrRenderClass(unref(currencies)?.USD.diff)}" data-v-578efbe6></span></span> | €: <span data-v-578efbe6>${ssrInterpolate(unref(currencies)?.EUR?.value)} <span class="${ssrRenderClass(unref(currencies)?.EUR.diff)}" data-v-578efbe6></span></span> | ¥: <span data-v-578efbe6>${ssrInterpolate(unref(currencies)?.CNY?.value)} <span class="${ssrRenderClass(unref(currencies)?.CNY.diff)}" data-v-578efbe6></span></span> | ₩: <span data-v-578efbe6>${ssrInterpolate(unref(currencies)?.KRW?.value)} <span class="${ssrRenderClass(unref(currencies)?.KRW.diff)}" data-v-578efbe6></span></span></div></div>`);
      } else {
        _push(`<!---->`);
      }
      _push(`</header>`);
...
const __nuxt_component_0 = /* @__PURE__ */ Object.assign(_export_sfc(_sfc_main$2, [["__scopeId", "data-v-578efbe6"]]), { __name: "AppHeader" });
const _sfc_main$1 = {};
...
//# sourceMappingURL=default-CZDlC8MB.mjs.map
