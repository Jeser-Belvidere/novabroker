...
import { _ as __nuxt_component_0$1 } from './Link-gmOukgFG.mjs';
...
const _sfc_main$2 = /* @__PURE__ */ defineComponent({
  ...
  async setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<header${ssrRenderAttrs(mergeProps({ class: "header" }, _attrs))} data-v-528b4025><div class="header-content" data-v-528b4025>`);
      ...
      _push(`<div class="header-content__links" data-v-528b4025>`);
      ...
      _push(`</div><div class="header-content__contacts" data-v-528b4025>`);
      ...
      _push(`</div><div class="mobile-menu" data-v-528b4025>`);
      _push(ssrRenderComponent(_component_UIMenu, null, null, _parent));
      _push(`</div></div>`);
      if (!unref(error)) {
        _push(`<div class="header-currency" data-v-528b4025><div class="header-currency__content" data-v-528b4025> $: <span data-v-528b4025>${ssrInterpolate(unref(currencies)?.USD?.value)} <span class="${ssrRenderClass(unref(currencies)?.USD.diff)}" data-v-528b4025></span></span> | €: <span data-v-528b4025>${ssrInterpolate(unref(currencies)?.EUR?.value)} <span class="${ssrRenderClass(unref(currencies)?.EUR.diff)}" data-v-528b4025></span></span> | ¥: <span data-v-528b4025>${ssrInterpolate(unref(currencies)?.CNY?.value)} <span class="${ssrRenderClass(unref(currencies)?.CNY.diff)}" data-v-528b4025></span></span> | ₩: <span data-v-528b4025>${ssrInterpolate(unref(currencies)?.KRW?.value)} <span class="${ssrRenderClass(unref(currencies)?.KRW.diff)}" data-v-528b4025></span></span></div></div>`);
      } else {
        _push(`<!---->`);
      }
      _push(`</header>`);
...
const __nuxt_component_0 = /* @__PURE__ */ Object.assign(_export_sfc(_sfc_main$2, [["__scopeId", "data-v-528b4025"]]), { __name: "AppHeader" });
const _sfc_main$1 = {};
...
//# sourceMappingURL=default-CS7tRLmg.mjs.map
