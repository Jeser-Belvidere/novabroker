import { _ as _export_sfc, b as useRoute, n as navigateTo, c as useHead, d as useSeoMeta, a as __nuxt_component_0$2 } from './server.mjs';
  ...
  setup(__props) {
    ...
    useHead({
      ...
      meta: [
        ...
        {
          name: "keywords",
          content: `${currentNews?.keywords ?? "ВЭД, новости, Таможенный брокер, Сертификация, Новаброкер, Novabroker"}`
        }
      ]
    });
    useSeoMeta({
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<main${ssrRenderAttrs(_attrs)} data-v-a1c79675><section data-v-a1c79675><div class="breadcrumbs margin-bottom" data-v-a1c79675>`);
      _push(ssrRenderComponent(_component_nuxt_link, {
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`${ssrInterpolate("< Новости")}`);
          } else {
            return [
              createTextVNode(toDisplayString("< Новости"))
            ];
          }
        }),
        _: 1
      }, _parent));
      _push(`</div><h1 class="margin-bottom" data-v-a1c79675>${ssrInterpolate(unref(currentNews)?.title)}</h1><div class="image margin-bottom" style="${ssrRenderStyle(`background-image: url(${unref(currentNews)?.imgSrc})`)}" data-v-a1c79675></div><div class="image-subtitle margin-bottom" data-v-a1c79675>${ssrInterpolate(unref(currentNews)?.date)}</div><div class="content" data-v-a1c79675><!--[-->`);
      ssrRenderList(unref(currentNews)?.newsBlocks, (newsBlock, index) => {
        _push(`<div class="margin-bottom" data-v-a1c79675>`);
...
//# sourceMappingURL=_newsId_-Bw4tzrtE.mjs.map
